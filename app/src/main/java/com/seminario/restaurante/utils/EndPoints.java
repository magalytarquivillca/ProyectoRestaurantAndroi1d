...
public class EndPoints {
    ...
    public static String UPDATE_LOGO_SERVICE = HOST + "updatelogo";
    public static String UPDATE_LUGAR_SERVICE = HOST + "updatelugar";
    public static String CREAR_MENU_SERVICE = HOST + "menu";
